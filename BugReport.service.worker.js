...
const CACHE_NAME = "BugReport-cache";
const OFFLINE_URL = "BugReport.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["BugReport.html","BugReport.js","BugReport.wasm","BugReport.pck","BugReport.offline.html","BugReport.icon.png","BugReport.apple-touch-icon.png"];
